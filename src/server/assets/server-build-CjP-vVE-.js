import { a as axios, g as getDefaultExportFromCjs, d as decode, v as verify, s as sign, J as JsonWebTokenError_1, N as NotBeforeError_1, T as TokenExpiredError_1, p as production, b as accessTokenCookie, r as refreshTokenCookie, c as reactExports, e as dist } from "./expressjs-handler-DFFxSqZw.js";
...
async function authenticateOrGoLogin(ctx, request) {
  try {
    return await authenticate(ctx, request);
  } catch (_) {
    throw production.redirect("/login");
  }
}
async function authenticateOrError(ctx, request) {
  try {
    return await authenticate(ctx, request);
  } catch (_) {
    return {
...
async function authenticate(ctx, request) {
  ...
  const unverifiedPayload = unverified;
  ...
  const verifying = new Promise((resolve) => {
    jwt.verify(
      ...
      (err, payload) => {
        ...
        } else if (err != null || payload == null || typeof payload == "string") {
  ...
  if (verifiedResult.kind == "success") {
    ...
    const issuedAt = verifiedPayload.iat;
    const expireAt = verifiedPayload.exp;
    const expireInSeconds = expireAt - issuedAt;
    const secondsToExpire = expireAt - Math.floor(Date.now() / 1e3);
...
function requireReactDomServerLegacy_node_production_min() {
  ...
  var ea = reactExports, fa = stream, n = Object.prototype.hasOwnProperty, ha = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, ia = {}, ja = {};
  function ka(a) {
...
function requireReactDomServer_node_production_min() {
  ...
  var aa = require$$1, ba = reactExports, k = null, l2 = 0, q = true;
  function r(a, b) {
    if ("string" === typeof b) {
  ...
  if (process.env.NODE_ENV !== "production") {
    (function() {
      ...
      function writeToDestination(destination, view2) {
        var currentHasCapacity = destination.write(view2);
    ...
    const { pipe, abort } = renderToPipeableStream(
      ...
      ),
      {
        [readyOption]() {
          ...
          const stream2 = dist.createReadableStreamFromReadable(body);
...
const stylesheet = "/assets/app-dux1UF7C.css";
const links = () => [{
  rel: "stylesheet",
  href: stylesheet
}];
...
const home = withComponentProps(function Home() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
    id: "index-page",
    children: ["This is a demo for Remix.", /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}), /* @__PURE__ */ jsxRuntimeExports.jsx(production.Link, {
      to: "/login",
...
const action$3 = async ({
  ...
  const {
    ...
    refreshToken,
    error
  } = await authenticateWithUserCredentials(context, request);
  if (error) {
    return {
      error
    };
...
const login = withComponentProps(function Screen({
  actionData
}) {
  const error = actionData == null ? void 0 : actionData.error;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    id: "index-page",
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(production.Form, {
      method: "post",
...
const action$2 = async ({
  ...
  if (intent === "LOGOUT") {
    return production.redirect("/", {
      headers: [["Set-Cookie", await accessTokenCookie.serialize("", {
        maxAge: 0,
        expires: /* @__PURE__ */ new Date(0)
      })], ["Set-Cookie", await refreshTokenCookie.serialize("", {
        maxAge: 0,
        expires: /* @__PURE__ */ new Date(0)
      })]]
    });
...
const layout = withComponentProps(function App2({
  loaderData
}) {
  const {
    contacts,
  ...
  const submit = production.useSubmit();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("h1", {
        children: ["Remix Contacts", /* @__PURE__ */ jsxRuntimeExports.jsxs(production.Form, {
          method: "post",
        ...
        children: contacts.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", {
          children: contacts.map((contact) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", {
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(production.NavLink, {
              className: ({
                isActive,
                isPending
              }) => isActive ? "active" : isPending ? "pending" : "",
              to: `${contact.id}`,
              children: [contact.firstName || contact.lastName ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
                children: [contact.firstName, " ", contact.lastName]
              }) : /* @__PURE__ */ jsxRuntimeExports.jsx("i", {
                children: "No Name"
              }), " ", contact.favorite ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                children: "★"
              }) : null]
            })
          }, contact.id))
      ...
      id: "detail",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(production.Outlet, {})
    })]
  });
});
...
const list = withComponentProps(function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", {
    id: "index-page",
    children: ["This is a demo for Remix.", /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}), "Check out ", /* @__PURE__ */ jsxRuntimeExports.jsx("a", {
...
const view = withComponentProps(function Contact({
  loaderData
}) {
  const {
    contact
    ...
    children: [/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
      ...
      children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("h1", {
        children: [contact.firstName || contact.lastName ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
          ...
          children: "No Name"
        }), " ", /* @__PURE__ */ jsxRuntimeExports.jsx(Favorite, {
          favorite: contact.favorite
        })]
      }), contact.twitter ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", {
          href: `https://twitter.com/${contact.twitter}`,
          children: contact.twitter
        })
      }) : null, contact.notes ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
        children: contact.notes
      }) : null, /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        children: [/* @__PURE__ */ jsxRuntimeExports.jsx(production.Form, {
          action: "edit",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
            type: "submit",
            children: "Edit"
          })
        }), /* @__PURE__ */ jsxRuntimeExports.jsx(production.Form, {
          action: "destroy",
          method: "post",
          onSubmit: (event) => {
...
function Favorite({
  ...
  const fetcher = production.useFetcher();
  const effectiveFavorite = fetcher.formData ? fetcher.formData.get("favorite") === "true" : favorite;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(fetcher.Form, {
    method: "post",
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
      "aria-label": effectiveFavorite ? "Remove from favorites" : "Add to favorites",
      name: "favorite",
      value: effectiveFavorite ? "false" : "true",
      children: effectiveFavorite ? "★" : "☆"
    })
  });
}
...
const edit = withComponentProps(function EditContact({
  loaderData
}) {
  const {
    contact
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(production.Form, {
    id: "contact-form",
    method: "post",
